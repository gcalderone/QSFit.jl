...
function plot(source::TypeI, model)
    ...
    source.options.use_galaxy  &&  (@gp :- domain(model) model(:continuum) .+ model(:galaxy) "w l t 'Cont+Host' lc rgb 'red'" :-)
    source.options.use_balmer  &&  (@gp :- domain(model) model(:balmer) "w l t 'Balmer' dt 4 lc rgb 'dark-green'" :-)
    source.options.use_ironuv  &&  (@gp :- domain(model) model(:ironuv) "w l t 'IronUV' lc rgb 'dark-green'" :-)
    source.options.use_ironopt &&  (@gp :- domain(model) model(:ironoptbr) "w l t 'IronOptB' lc rgb 'dark-green'" :-)
    source.options.use_ironopt &&  (@gp :- domain(model) model(:ironoptna) "w l t 'IronOptN' lc rgb 'dark-green'" :-)
